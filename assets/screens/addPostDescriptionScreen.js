...
import { DivideSquare } from 'react-native-feather';
...
const AddPostDescriptionScreen = ({route, navigation}) => {
    ...
    return(
        <View style={styles.container}>
            <TextInput multiline value={description} onChangeText={text => setDescription(text)} style={styles.descriptionInput} numberOfLines={5} placeholder='Add description' placeholderTextColor={'gray'}/>
            <TouchableOpacity style={styles.validateTouchable} onPress={() =>
            {   
                handlePost()
                setDescription('')

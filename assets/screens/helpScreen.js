...
const HelpScreen = () => {
    ...
    const [signOutDeleteToggle, setSignOutDeleteToggle] = useState(false);
    const [subToggleStates, setSubToggleStates] = useState({});
    const [openSubToggle, setOpenSubToggle] = useState(null);
        ...
        <ScrollView>
                <View style={styles.toggleBox}>
                    ...
                    {GuideUtilisationToggle &&
                        ...
                        <Text style={styles.subToggleText}>Why was my post/comment    deleted ?</Text>
